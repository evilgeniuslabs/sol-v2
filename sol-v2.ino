...
PatternAndNameList patterns = {
  ...
  { incrementalDrift,       "Incremental Drift" },
...
void juggle() {
  ...
  for ( int i = 0; i < dotcount; i++) {
    leds[beatsin16(i + (dotcount - 1), 0, NUM_LEDS - 1)] |= ColorFromPalette(gCurrentPalette, dothue); // CHSV(dothue, 200, 255);
    dothue += (256 / dotcount);
  }
}
